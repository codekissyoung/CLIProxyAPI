...
type RoutingConfig struct {
	...
	// ProviderStrategies optionally overrides the global strategy by provider.
	ProviderStrategies map[string]string `yaml:"provider_strategies,omitempty" json:"provider_strategies,omitempty"`

	// ClaudeCodeSessionAffinity is retained for backward compatibility.
	// Deprecated: use SessionAffinity.
